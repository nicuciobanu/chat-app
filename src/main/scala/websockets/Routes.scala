...
import websockets.SuccessfulRegistration.{ChatMsg, DiscardMessage, KeepAlive, SendToUser}
import websockets.Util.{ChatState, User}
    ...
    HttpRoutes
      .of[F] {
        ...
        case GET -> Root / "metrics" =>
          ...
          currentState.flatMap(currState => Ok(currState, `Content-Type`(MediaType.text.html)))
